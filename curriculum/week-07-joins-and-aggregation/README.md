# Week 07 — Joins and Aggregation over Assay Data
...
**Depends on:** weeks 00–06

**Topic scope:** Inner, outer, semi and anti joins; GROUP BY, HAVING and aggregate functions over activity observations.
...
```bash
make test-week WEEK=week-07-joins-and-aggregation
```
...
- [ ] `make test-week WEEK=week-07-joins-and-aggregation` passes.
...
Save to `docs/portfolio/week-07/`:
...
```bash
git add -A
git commit -m "<type>(week-07): <imperative summary>"
```
