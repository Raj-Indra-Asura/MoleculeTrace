# Week 09 — Constraints and Data Integrity
...
**Depends on:** weeks 00–08

**Topic scope:** CHECK constraints, domains, UNIQUE, NOT NULL, referential actions and how integrity rules encode assay validity.
...
```bash
make test-week WEEK=week-09-constraints-and-integrity
```
...
- [ ] `make test-week WEEK=week-09-constraints-and-integrity` passes.
...
Save to `docs/portfolio/week-09/`:
...
```bash
git add -A
git commit -m "<type>(week-09): <imperative summary>"
```
