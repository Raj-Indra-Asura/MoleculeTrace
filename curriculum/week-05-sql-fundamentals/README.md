# Week 05 — SQL Fundamentals and Data Loading
...
**Depends on:** weeks 00–04

**Topic scope:** INSERT, SELECT, UPDATE, DELETE, NULL semantics and bulk loading of clearly labelled synthetic molecule and assay data.
...
```bash
make test-week WEEK=week-05-sql-fundamentals
```
...
- [ ] `make test-week WEEK=week-05-sql-fundamentals` passes.
...
Save to `docs/portfolio/week-05/`:
...
```bash
git add -A
git commit -m "<type>(week-05): <imperative summary>"
```
