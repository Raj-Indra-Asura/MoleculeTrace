# Week 06 — Relational Algebra and Query Equivalence
...
**Phase:** 1. Design quality · **Required effort:** 5 hours ·
**Depends on:** weeks 00–05

**Topic scope:** Selection, projection, product, join, set operations, rename and division, each paired with equivalent SQL over MoleculeTrace.
...
**Indexed in labs/:** [`labs/relational-algebra.md`](../../labs/relational-algebra.md)
...
```bash
make test-week WEEK=week-06-relational-algebra
```
...
- [ ] `make test-week WEEK=week-06-relational-algebra` passes.
...
Save to `docs/portfolio/week-06/`:
...
```bash
git add -A
git commit -m "<type>(week-06): <imperative summary>"
```
