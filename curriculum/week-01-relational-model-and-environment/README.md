# Week 01 — The Relational Model and a Reproducible Environment
...
**Depends on:** weeks 00–00

**Topic scope:** Relations, schemas, keys and data independence, grounded in a PostgreSQL instance started from Docker Compose.
...
- [ ] `make test-week WEEK=week-01-relational-model-and-environment` passes.
...
```bash
git add -A
git commit -m "<type>(week-01): <imperative summary>"
```
