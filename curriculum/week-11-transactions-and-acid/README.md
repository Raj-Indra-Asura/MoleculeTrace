...
**Phase:** 3. Application layer · **Required effort:** 5 hours ·
**Depends on:** weeks 00–10

**Topic scope:** Transaction states, ACID properties, savepoints and correct transaction boundaries for multi-table ingestion.
...
**Indexed in labs/:** [`labs/transactions.md`](../../labs/transactions.md)
...
```bash
make test-week WEEK=week-11-transactions-and-acid
```
...
- [ ] `make test-week WEEK=week-11-transactions-and-acid` passes.
...
Save to `docs/portfolio/week-11/`:
...
```bash
git add -A
git commit -m "<type>(week-11): <imperative summary>"
```
