# Week 03 — Logical Design and DDL
...
**Depends on:** weeks 00–02

**Topic scope:** ER-to-relational mapping, data types, primary and foreign keys, and the first migration that creates the core schema.
...
```bash
make test-week WEEK=week-03-logical-design-and-ddl
```
...
- [ ] `make test-week WEEK=week-03-logical-design-and-ddl` passes.
...
Save to `docs/portfolio/week-03/`:
...
```bash
git add -A
git commit -m "<type>(week-03): <imperative summary>"
```
