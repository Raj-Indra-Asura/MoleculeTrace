# Week 18 — Storage Layout and B+ Trees
...
**Phase:** 5. Internals · **Required effort:** 5 hours ·
**Depends on:** weeks 00–17

**Topic scope:** Pages, tuples, heap files, TOAST and fill factor, plus B+ tree structure, search, insertion and node splitting.
...
**Indexed in labs/:** [`labs/bplus-tree.md`](../../labs/bplus-tree.md)
...
```bash
make test-week WEEK=week-18-storage-and-bplus-trees
```
...
- [ ] `make test-week WEEK=week-18-storage-and-bplus-trees` passes.
...
Save to `docs/portfolio/week-18/`:
...
```bash
git add -A
git commit -m "<type>(week-18): <imperative summary>"
```
