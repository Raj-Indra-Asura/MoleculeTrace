# Week 20 — Concurrency Control and Isolation
...
**Phase:** 6. Reliability · **Required effort:** 5 hours ·
**Depends on:** weeks 00–19

**Topic scope:** Schedules and serialisability, two-phase locking, deadlocks, timestamp ordering and PostgreSQL MVCC in two live sessions.
...
**Indexed in labs/:** [`labs/transactions.md`](../../labs/transactions.md) · [`labs/concurrency.md`](../../labs/concurrency.md)
...
```bash
make test-week WEEK=week-20-concurrency-control
```
...
- [ ] `make test-week WEEK=week-20-concurrency-control` passes.
...
Save to `docs/portfolio/week-20/`:
...
```bash
git add -A
git commit -m "<type>(week-20): <imperative summary>"
```
