# Week 19 — Hashing and Hash-Based Access
...
**Depends on:** weeks 00–18

**Topic scope:** Static, extendible and linear hashing, collisions and overflow, hash indexes, hash joins and hash aggregation.
...
**Indexed in labs/:** [`labs/hashing.md`](../../labs/hashing.md)
...
```bash
make test-week WEEK=week-19-hashing
```
...
- [ ] `make test-week WEEK=week-19-hashing` passes.
...
Save to `docs/portfolio/week-19/`:
...
```bash
git add -A
git commit -m "<type>(week-19): <imperative summary>"
```
