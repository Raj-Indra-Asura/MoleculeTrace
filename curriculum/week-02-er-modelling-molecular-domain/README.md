# Week 02 — ER Modelling the Molecular Domain
...
**Topic scope:** Entities, relationships, cardinality, participation and weak entities for molecules, targets, assays and activity observations.
...
- [ ] `make test-week WEEK=week-02-er-modelling-molecular-domain` passes.
...
```bash
git add -A
git commit -m "<type>(week-02): <imperative summary>"
```
