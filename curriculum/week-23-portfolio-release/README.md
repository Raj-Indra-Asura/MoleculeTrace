...
**Depends on:** weeks 00–22

**Topic scope:** Documentation, diagrams, a reproducible demo path, a tagged release and an interview-ready write-up of the whole system.
...
```bash
make test-week WEEK=week-23-portfolio-release
```
...
- [ ] `make test-week WEEK=week-23-portfolio-release` passes.
...
Save to `docs/portfolio/week-23/`:
...
```bash
git add -A
git commit -m "<type>(week-23): <imperative summary>"
```
