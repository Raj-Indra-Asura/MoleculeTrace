...
- [ ] <verifiable database or application state, with the exact query or command
      that proves it and the exact expected result>
- [ ] Outputs match the files in `expected-outputs/`.

## Artefacts

- [ ] Required exercises committed.
- [ ] `LEARNING_NOTES.md` and `REFLECTION.md` filled in.
- [ ] Portfolio evidence saved to `docs/portfolio/week-16/`.
